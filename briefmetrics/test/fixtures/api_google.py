...
data['ga:fullReferrer'] = ['lists.of/great-websites', 'blog.verypopular.com/2016/analytics-in-your-inbox', 'reddit.com/r/analytics', 'wikipedia.org/wiki/Briefmetrics', 'producthunt.com/tech/briefmetrics', 'slashdot.org/story/best-mobile-google-analytics-reports', 'techcrunch.com/best-analytics-summaries']
data['ga:pagePath'] = ['/store', '/account/create', '/account/dashboard', '/about', '/search', '/pricing', '/']
...
data['ga:productName'] = ['Plombus', 'Teleporter', 'Mousepad', 'Juicebox', 'Paperweight', 'T-Shirt']
data['ga:itemRevenue'] = [169.20, 143.2, 92, 14, 0.0, 0.0, 0.0]
data['ga:itemQuantity'] = [3, 11, 8]
