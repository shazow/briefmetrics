...
<p>
    Google Analytics returned no results for your site: ${c.report.display_name}
</p>

<p>
    Do you see any data in
    <a href="${h.ga_permalink('report/content-pages', c.report)}">your Google Analytics report here</a>?
</p>
    ...
    <li>
        ...
        <ul>
            <li>
                ...
                <a href="${h.ga_permalink('management/Settings', c.report)}/%3Fm.page%3DTrackingCode/">your Tracking Code status and instructions here</a>.
            </li>
            <li>
...
<p>
    ...
    <a href="http://briefmetrics.com/account/disconnect?token=${c.user.unsubscribe_token}">delete your account</a>.
</p>
